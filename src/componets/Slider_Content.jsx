...
export default function Slider_Content({textOne,bigTitle1,bigTitle2, btn1, btn2,imgLeft, imgRight}) {
  return (
    ...
    <div className='content text-center flex flex-col gap-10'>
        ...
        <a href="#_" class="text-[20px] px-10 py-2.5 min-w-[200px] m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-gray-900 text-gray-900 text-white">
        ...
        <a href="#_" class="relative text-[20px] min-w-[200px] px-10 py-2.5 overflow-hidden group bg-yellow-500 relative hover:bg-gradient-to-r hover:from-yellow-500 hover:to-yellow-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-yellow-400 transition-all ease-out duration-300">
